...
const actionClass =
  'border px-5 py-[15px] font-pretendard text-body leading-none tracking-[-0.32px] transition-colors cursor-pointer shrink-0';
...
const ReportDetailPage = ({ report, gif }: ReportDetailPageProps) => (
  <main className="bg-cream min-h-[calc(100vh-69px)] px-5 py-10 sm:px-12 lg:px-36">
    <div className="mx-auto flex w-full max-w-[1152px] flex-col gap-8">
      ...
      <h1 className="font-pretendard text-h2 text-ink font-semibold tracking-[-1px]">신고 상세</h1>

      {/* 신고 정보 */}
      <div className="flex flex-wrap gap-x-12 gap-y-4">
        <Field label="신고자" value={report.reporter} />
        <Field label="신고사유" value={report.reason} />
        <Field label="신고내용" value={report.content} />
      </div>
